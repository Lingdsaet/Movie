...
public partial class movieDB : DbContext
{
    ...
    public object MovieRepository { get; internal set; }
        ...
        modelBuilder.Entity<Movie>(entity =>
        {
            ...
            entity.HasMany(d => d.Actors).WithMany(p => p.Movies)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("MovieId", "ActorsId").HasName("PK__MovieAct__75B25D7DE91BD012");
            ...
            entity.HasMany(d => d.Categories).WithMany(p => p.Movies)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("MovieId", "CategoriesId").HasName("PK__MovieCat__552D0441A8F57D73");
